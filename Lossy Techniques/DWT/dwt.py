...
def compress(image_path, threshold):
    ...
    newimage.save('compresseddwt.jpg')
...
def compressed_percentage(image_path, threshold):
    ...
    print("comp:",original_size/final_size)
...
def main():
    if len(sys.argv) > 1:
        ...
        print("compression percentages:",percentages_list)
        ...
        original_image = cv2.imread('../img_gray.jpg')
        file_size_bytes = os.path.getsize('img_gray.jpg')
        memory_size_in = file_size_bytes / 1024
        file_size_bytes = os.path.getsize("compresseddwt.jpg")
        ...
        reconstructed_image = cv2.imread('../0.png')
        compressed_image = cv2.imread('compresseddwt.jpg')
